...
func TestBuilder(t *testing.T) {
	tests := []struct {
		...
		},
		{
			"JoinQuery",
			func() *query.Builder {
				return query.NewBuilder(db.NewMySQLQueryBuilder(), cache.NewAsyncQueryCache(100)).JoinQuery("users", func(b *query.JoinClauseBuilder) {
		...
		},
		{
			"LeftJoinQuery",
			func() *query.Builder {
				return query.NewBuilder(db.NewMySQLQueryBuilder(), cache.NewAsyncQueryCache(100)).LeftJoinQuery("users", func(b *query.JoinClauseBuilder) {
					b.On("users.id", "=", "profiles.user_id").OrOn("users.id", "=", "profiles.alter_user_id").Where("profiles.age", ">", 18)
				})
			},
		...
		},
		{
			"RightJoinQuery",
			func() *query.Builder {
				return query.NewBuilder(db.NewMySQLQueryBuilder(), cache.NewAsyncQueryCache(100)).RightJoinQuery("users", func(b *query.JoinClauseBuilder) {
					b.On("users.id", "=", "profiles.user_id").OrOn("users.id", "=", "profiles.alter_user_id").Where("profiles.age", ">", 18)
				})
			},
...
func TestWhereSelectBuilder(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			func() *query.Builder {
				sq := query.NewBuilder(db.NewMySQLQueryBuilder(), cache.NewAsyncQueryCache(100)).Select("id").Table("users").Where("name", "=", "John")
				return query.NewBuilder(db.NewMySQLQueryBuilder(), cache.NewAsyncQueryCache(100)).WhereSubQuery("user_id", "IN", sq).Where("city", "=", "New York")
			},
		...
		},
		{
			...
			func() *query.Builder {
				sq := query.NewBuilder(db.NewMySQLQueryBuilder(), cache.NewAsyncQueryCache(100)).Select("id").Table("users").Where("name", "=", "John")
				return query.NewBuilder(db.NewMySQLQueryBuilder(), cache.NewAsyncQueryCache(100)).Where("city", "=", "New York").OrWhereSubQuery("user_id", "IN", sq)
			},
		...
		},
		{
			...
			func() *query.Builder {
				return query.NewBuilder(db.NewMySQLQueryBuilder(), cache.NewAsyncQueryCache(100)).
					WhereGroup(func(b *query.WhereBuilder[query.Builder]) {
		...
		},
		{
			...
			func() *query.Builder {
				return query.NewBuilder(db.NewMySQLQueryBuilder(), cache.NewAsyncQueryCache(100)).
					Where("city", "=", "New York").
					OrWhereGroup(func(b *query.WhereBuilder[query.Builder]) {
						b.Where("age", ">", 18).Where("name", "=", "John")
					})
			},
		...
		},
		{
			...
			func() *query.Builder {
				return query.NewBuilder(db.NewMySQLQueryBuilder(), cache.NewAsyncQueryCache(100)).
					WhereNot(func(b *query.WhereBuilder[query.Builder]) {
						b.Where("age", ">", 18).Where("name", "=", "John")
					})
			},
		...
		},
		{
			...
			func() *query.Builder {
				return query.NewBuilder(db.NewMySQLQueryBuilder(), cache.NewAsyncQueryCache(100)).
					Where("city", "=", "New York").
					OrWhereNot(func(b *query.WhereBuilder[query.Builder]) {
						b.Where("age", ">", 18).Where("name", "=", "John")
					})
			},
		...
		},
		{
			"WhereExists",
			func() *query.Builder {
				return query.NewBuilder(db.NewMySQLQueryBuilder(), cache.NewAsyncQueryCache(100)).WhereExists(func(b *query.Builder) {
		...
		},
		{
			"OrWhereExists",
			func() *query.Builder {
				return query.NewBuilder(db.NewMySQLQueryBuilder(), cache.NewAsyncQueryCache(100)).Where("city", "=", "New York").OrWhereExists(func(b *query.Builder) {
					b.Select("id").Table("users").Where("name", "=", "John")
				})
			},
		...
		},
		{
			"WhereNotExists",
			func() *query.Builder {
				return query.NewBuilder(db.NewMySQLQueryBuilder(), cache.NewAsyncQueryCache(100)).WhereNotExists(func(b *query.Builder) {
					b.Select("id").Table("users").Where("name", "=", "John")
				})
			},
		...
		},
		{
			"OrWhereNotExists",
			func() *query.Builder {
				return query.NewBuilder(db.NewMySQLQueryBuilder(), cache.NewAsyncQueryCache(100)).Where("city", "=", "New York").OrWhereNotExists(func(b *query.Builder) {
					b.Select("id").Table("users").Where("name", "=", "John")
				})
			},
